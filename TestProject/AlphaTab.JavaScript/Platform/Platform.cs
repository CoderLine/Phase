...
namespace AlphaTab.Platform
{
    public static partial class Platform
    {
        ...
        {
            var stack = Haxe.CallStack.ToString(Haxe.CallStack.Get());
            ...
            switch (logLevel)
            {
                case LogLevel.None:
                    break;
                case LogLevel.Debug:
                    Script.Write("untyped console.debug(msg, details);");
                    break;
                case LogLevel.Info:
                    Script.Write("untyped console.info(msg, details);");
                    break;
                case LogLevel.Warning:
                    Script.Write("untyped console.warn(msg, details);");
                    break;
                case LogLevel.Error:
                    Script.Write("untyped console.error(msg, stack, details);");
                    break;
            }
        }
