...
using Phase.Translator.Kotlin.Statements;

namespace Phase.Translator.Kotlin
{
    public class VisitorBlock : AbstractKotlinEmitterBlock
    {
        private readonly SyntaxNode _node;
        public AbstractKotlinEmitterBlock FirstBlock { get; set; }

        public VisitorBlock(KotlinEmitterContext context, SyntaxNode node)
            : base(context)
        {
            _node = node;
        }
        ...
        {
            private readonly KotlinEmitterContext _context;
            private readonly CancellationToken _cancellationToken;

            public AbstractKotlinEmitterBlock FirstBlock { get; set; }

            public Visitor(KotlinEmitterContext context, CancellationToken cancellationToken)
            {
                _context = context;
            ...
            private void Emit<TBlock, TSyntax>(TSyntax syntax)
                where TBlock : AbstractKotlinEmitterBlock<TSyntax>, new()
