...
using Phase.Translator.Java.Statements;

namespace Phase.Translator.Java
{
    public class VisitorBlock : AbstractJavaEmitterBlock
    {
        private readonly SyntaxNode _node;
        public AbstractJavaEmitterBlock FirstBlock { get; set; }

        public VisitorBlock(JavaEmitterContext context, SyntaxNode node)
            : base(context)
        {
            _node = node;
        }
        ...
        {
            private readonly JavaEmitterContext _context;
            private readonly CancellationToken _cancellationToken;

            public AbstractJavaEmitterBlock FirstBlock { get; set; }

            public Visitor(JavaEmitterContext context, CancellationToken cancellationToken)
            {
                _context = context;
            ...
            private void Emit<TBlock, TSyntax>(TSyntax syntax)
                where TBlock : AbstractJavaEmitterBlock<TSyntax>, new()
