...
{
    public class InterfaceBlock : AbstractJavaEmitterBlock
    {
        private readonly PhaseInterface _type;
        private string _package;
        private string _name;

        public InterfaceBlock(JavaEmitterContext context)
            : this(context.CurrentType, context)
        {
        }

        public InterfaceBlock(PhaseType type, JavaEmitterContext emitter)
            : base(emitter)
        {
