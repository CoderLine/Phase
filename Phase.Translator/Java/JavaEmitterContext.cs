...
{
    public class JavaEmitterContext : BaseEmitterContext<JavaEmitter>
    {
        ...
        public override string FileName
        {
            get
            {
                ...
                return name.Replace('.', Path.DirectorySeparatorChar) + ".java";
            }
        }

        public int RecursiveForeach { get; set; }

        public JavaEmitterContext(JavaEmitter emitter, PhaseType type)
            : base(emitter, type)
        {
        }
