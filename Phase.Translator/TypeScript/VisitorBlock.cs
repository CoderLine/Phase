...
{
    public class VisitorBlock : AbstractTypeScriptEmitterBlock
    {
        private readonly SyntaxNode _node;
        public AbstractTypeScriptEmitterBlock FirstBlock { get; set; }

        public VisitorBlock(TypeScriptEmitterContext context, SyntaxNode node)
            : base(context)
        {
            _node = node;
        }
        ...
        {
            private readonly TypeScriptEmitterContext _context;
            private readonly CancellationToken _cancellationToken;

            public AbstractTypeScriptEmitterBlock FirstBlock { get; set; }

            public Visitor(TypeScriptEmitterContext context, CancellationToken cancellationToken)
            {
                _context = context;
            ...
            private void Emit<TBlock, TSyntax>(TSyntax syntax)
                where TBlock : AbstractTypeScriptEmitterBlock<TSyntax>, new()
