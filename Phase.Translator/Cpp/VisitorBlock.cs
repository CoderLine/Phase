...
using Phase.Translator.Cpp.Statements;

namespace Phase.Translator.Cpp
{
    public class VisitorBlock : AbstractCppEmitterBlock
    {
        private readonly SyntaxNode _node;
        public AbstractCppEmitterBlock FirstBlock { get; set; }

        public VisitorBlock(CppEmitterContext context, SyntaxNode node)
        {
            Init(context);
            _node = node;
        }
        ...
        {
            private readonly CppEmitterContext _context;
            private readonly CancellationToken _cancellationToken;

            public AbstractCppEmitterBlock FirstBlock { get; set; }

            public Visitor(CppEmitterContext context, CancellationToken cancellationToken)
            {
                _context = context;
            ...
            private void Emit<TBlock, TSyntax>(TSyntax syntax)
                where TBlock : AbstractCppEmitterBlock<TSyntax>, new()
